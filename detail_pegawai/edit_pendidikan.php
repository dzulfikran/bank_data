<?php
    ...
    $data = query("SELECT * FROM pegawai INNER JOIN pendidikan ON pegawai.id_pegawai=pendidikan.id_pegawai WHERE id_pendidikan='$id'");
?>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">
        <a href="<?= base_url('detail_pegawai') ?>?id=<?= $data[0]['id_pegawai'] ?>">Detail Pegawai</a>
    </li>
        ...
        <form method="POST" action="<?= base_url('_config/proses_pendidikan') ?>?edit">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <input type="hidden" name="id_pegawai" id="id_pegawai" class="form-control" value="<?= $data[0]['id_pegawai'] ?>">
