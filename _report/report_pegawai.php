<?php
    ...
    $content .= '
        ...
        $no = 1;
        $pendidikan = query("SELECT * FROM pendidikan WHERE id_pegawai = '$id_pegawai' ");
    ...
    $content .= '
        ...
        $no = 1;
        $jabatan = query("SELECT * FROM jabatan WHERE id_pegawai = '$id_pegawai' ");
    ...
    $content .= '
        ...
        $no = 1;
        $pangkat = query("SELECT * FROM pangkat WHERE id_pegawai = '$id_pegawai' ");
